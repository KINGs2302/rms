...
function Billing() {
  ...
  return (
    <div className="p-5 h-full w-full flex flex-col items-center bg-gray-100 overflow-auto">
      <h1 className="text-3xl font-bold mb-6 text-gray-800 text-center">Billing Section</h1>
      ...
      <input
        ...
        className="border rounded-md px-2 py-1 mb-4 w-full max-w-md"
        value={searchBillNo}
      ...
      {loading ? (
        ...
        <p className="text-lg text-gray-600 text-center">
          No {showHistory ? "paid" : "unpaid"} orders available
        </p>
      ) : (
